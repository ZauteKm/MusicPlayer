...
### Pre Requisites 
- `API_ID` : [my.telegram.org](https://my.telegram.org/app) or [http:t.me/UseTGzKBot](@UseTGzKBot)
- `API_HASH` : Get from [my.telegram.org](https://my.telegram.org/app) or [http:t.me/UseTGzKBot](@UseTGzKBot)
